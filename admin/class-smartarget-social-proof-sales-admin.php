 ...
 */
class SmartargetSocialProofSales_Admin {
	...
	public function add_plugin_admin_menu() {
		...
		*/
		add_options_page( 'Smartarget Social Sales Settings', 'Smartarget Social Sales', 'manage_options', $this -> plugin_name, array($this, 'display_plugin_setup_page'));
	}
	...
	public function display_plugin_setup_page() {
		...
		include_once( 'partials/smartarget-social-proof-sales-admin-display.php' );
	}
